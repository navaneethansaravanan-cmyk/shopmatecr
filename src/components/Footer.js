export const Footer = () => {
  return (
    <footer className="bg-neutral-primary-soft border-t dark:bg-gray-800 dark:text-gray-100 dark:border-gray-600" >
        <div className="mx-auto w-full p-4 py-6 lg:py-8 md:items-center ">
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-body sm:text-center">© 2026 SNB Store™. All Rights Reserved.
              </span>
